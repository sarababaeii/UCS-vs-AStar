...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Path solution = uniformCostSearch(problem);
        if (solution == null) {
    ...
    public static Path uniformCostSearch(Problem problem) {
        ...
        while (true) {
            ...
            for (Action action: problem.getActions()) {
                expand(frontier, explored, node, action);
            }
        }
    }

    public static void expand(PriorityQueue<Node> frontier, Set<State> explored, Node node, Action action) {
    ...
    public static void updatePathCost(PriorityQueue<Node> frontier, Node node, int pathCost) {
